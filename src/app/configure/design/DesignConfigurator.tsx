    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
          ...
          <div
            className={cn(
              "absolute inset-0 left-[3px] right-[3px] bottom-px top-px rounded-[32px]",
              `bg-${options.color.tw}`
            )}
          />
        </div>
                    ...
                    <DropdownMenuContent className="w-full">
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          ...
                          className={cn(
                            "flex text-sm items-center gap-1 p-1.5 cursor-default hover:bg-zinc-100 w-full",
                            {
                              "bg-primary/10":
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          ...
                          >
                            ...
                            <RadioDescription
                              as="span"
                              className="mt-2 flex text-sm sm:ml-2 sm:mt-0 sm:flex-col sm:text-right"
                            >
