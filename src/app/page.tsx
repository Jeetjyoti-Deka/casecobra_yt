        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 h-36 left-0 -top-20 hidden lg:block">
                <Image
                  src="/snake-1.png"
                  fill
                  alt="snake icon"
              ...
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a{" "}
                <span className="bg-green-600 px-3 text-white">Custom</span>{" "}
                Phone Case
              </h1>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              <div className="flex gap-0.5 mb-2">
                <Star className="h-5 -5 text-green-600 fill-green-600" />
                <Star className="h-5 -5 text-green-600 fill-green-600" />
                <Star className="h-5 -5 text-green-600 fill-green-600" />
                <Star className="h-5 -5 text-green-600 fill-green-600" />
                <Star className="h-5 -5 text-green-600 fill-green-600" />
              ...
              <div className="text-lg leading-8">
                <p className="">
                  &quot;The case feels durable and I even gat a complaint on the
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <li className="w-fit">
              <Check className="text-green-600 h-5 w-5 inline mr-1.5" />5 year
              print warranty
            </li>
